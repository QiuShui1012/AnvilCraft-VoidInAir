...
public class GuardianAttackSelectorMixin {
    @ModifyConstant(method = "test", constant = @Constant(doubleValue = 9.0))
    private double decreaseRangeForDolphinAmulet(double constant, @Local(argsOnly = true, name = "target") LivingEntity target) {
